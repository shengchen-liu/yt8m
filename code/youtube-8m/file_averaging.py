...
def main():
    say()
    # model_pred = {
    #     'prediction_multiscale_cnn_lstm_model_batch128_decay08':1,
    #     'predictions_gatedlightvladLF-256k-1024-80-0002-300iter-norelu-basic-gatedmoe': 1,
    #     'predictions_video_level_MoeModel': 1
    #
    # }
    # print("hello")
    # avg = read_models(model_pred)
    # write_models(avg, 'average_submission_version1', sum(model_pred.values()))
